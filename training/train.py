...
Original file is located at
    https://colab.research.google.com/drive/1WwMHzzbZVT870Lg3QLeO1fDeEAHawquX
"""
...
# Lưu vocab và inv_vocab bằng pickle
...
while prepro1 != 'q':
    ...
    txt = pad_sequences(txt, maxlen=13, padding='post')
    ...
    while not stop_condition:
        ...
        sampled_word = inv_vocab.get(sampled_word_index, '<UNK>') + ' '
    ...
    print("chatbot attention :", decoded_translation.strip())
    print("==============================================")